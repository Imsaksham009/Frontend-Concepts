...
- [First, Why Does "Async" Even Need to Exist?](#first-why-does-async-even-need-to-exist)
- [Synchronous Execution — The Simple Case](#synchronous-execution--the-simple-case)
- [The Problem with Waiting — and Why JS Can't Do It Alone](#the-problem-with-waiting--and-why-js-cant-do-it-alone)
- [The Complete Architecture — All the Pieces Together](#the-complete-architecture--all-the-pieces-together)
- [The Complete Execution Flow — Step by Step](#the-complete-execution-flow--step-by-step)
- [The Priority System — Macrotasks vs Microtasks](#the-priority-system--macrotasks-vs-microtasks)
- [How `setTimeout` Really Works Internally](#how-settimeout-really-works-internally)
- [The Complete Flow Visualized](#the-complete-flow-visualized)
- [One More Piece — `requestAnimationFrame`](#one-more-piece--requestanimationframe)
